...
export default function AboutPage() {
  ...
  return (
    <div className="bg-gray-800 text-white min-h-screen pt-16">
      {/* Centered Container */}
      <div className="container mx-auto px-6">
        {/* About Section */}
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-teal-400">About Us</h1>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member, index) => (
            <motion.div key={index} whileHover={{ scale: 1.05 }}>
              <Card className="bg-gray-700 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-teal-400">{member.name}</h3>
                  <p className="text-gray-400">{member.role}</p>
                  <Button
                    className="mt-2 text-teal-400 flex items-center hover:text-teal-500"
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-teal-400 text-center">Our Journey</h2>
          <div className="mt-8 space-y-6">
            <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: -50 }}>
              <div className="border-l-4 border-teal-500 pl-4">
                <h3 className="text-xl font-semibold text-teal-400">Founded in 2024</h3>
                <p className="text-gray-300">A group of passionate developers came together to create innovative solutions.</p>
              </div>
            </motion.div>
            <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 50 }}>
              <div className="border-l-4 border-teal-500 pl-4">
                <h3 className="text-xl font-semibold text-teal-400">First Major Project</h3>
                <p className="text-gray-300">Successfully launched our first full-stack application.</p>
              </div>
            </motion.div>
            <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 50 }}>
              <div className="border-l-4 border-teal-500 pl-4">
                <h3 className="text-xl font-semibold text-teal-400">Notable Features</h3>
        ...
        <footer className="bg-gray-900 text-white py-4 mt-16">
          <div className="container mx-auto text-center">
            ...
            <div className="mt-2">
              <a href="/privacy" className="text-teal-400 hover:text-teal-500 mx-2">Privacy Policy</a>
              <a href="/terms" className="text-teal-400 hover:text-teal-500 mx-2">Terms of Service</a>
            </div>
          </div>
        </footer>
      </div>
